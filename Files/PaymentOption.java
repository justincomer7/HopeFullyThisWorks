...
public class PaymentOption extends JFrame {
	...
	public PaymentOption(double totalPrice, FinalOrder order) {
		...
		lblNewLabel.setBounds(10, 36, 218, 54);
		...
		btnNewButton_1.setBounds(139, 119, 89, 23);
		contentPane.add(btnNewButton_1);
		
		JLabel lblNewLabel_1 = new JLabel();
		lblNewLabel_1.setBackground(Color.WHITE);
		Image img = new ImageIcon(this.getClass().getResource("Visa.jpg")).getImage();
		lblNewLabel_1.setIcon(new ImageIcon(new ImageIcon(img).getImage().getScaledInstance(100, 48, Image.SCALE_DEFAULT)));
		lblNewLabel_1.setBounds(255, 11, 109, 40);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel();
		Image img2 = new ImageIcon(this.getClass().getResource("MasterCard.jpeg")).getImage();
		lblNewLabel_2.setIcon(new ImageIcon(new ImageIcon(img2).getImage().getScaledInstance(100, 48, Image.SCALE_DEFAULT)));
		...
		lblNewLabel_3.setIcon(new ImageIcon(new ImageIcon(img3).getImage().getScaledInstance(100, 48, Image.SCALE_DEFAULT)));
		lblNewLabel_3.setBackground(Color.WHITE);
		lblNewLabel_3.setBounds(255, 109, 109, 40);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel();
		Image img4 = new ImageIcon(this.getClass().getResource("Discover.jpg")).getImage();
		lblNewLabel_4.setIcon(new ImageIcon(new ImageIcon(img4).getImage().getScaledInstance(100, 48, Image.SCALE_DEFAULT)));
		lblNewLabel_4.setBackground(Color.WHITE);
		lblNewLabel_4.setBounds(255, 160, 109, 40);
